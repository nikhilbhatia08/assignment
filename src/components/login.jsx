                    ...
                    <div className='w-[44%]'>
                        ...
                        <div className='p-4'>
                            ...
                            <div className='mt-4'>
                                ...
                                <input type='email' value={username} onChange={(e) => setUsername(e.target.value)} className='font-mono border font-light bg-gray-50 p-2 w-full mt-2 resize-none border-gray-300 rounded-md focus:outline-none' placeholder='Enter Your Email or username'/>
                            ...
                            <div>
                                <h1 className='mt-4 font-mono text-gray-400'>Don't have an account? 
                                    <Link to={'/signup'}>
